...
export const AddRoomTypePanel = ({
  ...
  const onFileChange = (e) => handleFileChange({ e, setForm });

  const onRemovePhoto = (index) => removePhoto({ index, setForm });
  ...
  const onDrop = (e) => {
    ...
    setIsDragging(false);
    handleFileChange({
      e: { files: e.dataTransfer.files, target: { value: "" } },
      setForm,
    });
  };
                ...
                <>
                  <div className="rounded-lg bg-blue-500/10 border border-blue-500/20 p-4 mb-4">
                    <p className="text-sm text-blue-700 dark:text-blue-300">
                      YadoSync works with bed spaces, Adult beds can sleep
                      adults and children, child beds are for children only.
                      <br />
                      <br />
                      Example: If you have a family room that has 1 double bed
                      and 2 single beds, just enter 4 for adults and 0 for
                      children since children can sleep in adult beds.
                    </p>
                  </div>
                  <Field
                    label={
                      <>
                        Title (e.g. Deluxe Double Room){" "}
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    ...
                    >
                      <input
                        ...
                        onChange={(e) =>
                          setForm((f) => ({ ...f, occ_adults: e.target.value }))
                        }
                      />
                    </Field>
                    <Field
                    ...
                    >
                      <input
                        ...
                        onChange={(e) =>
                          setForm((f) => ({
                            ...f,
                            default_occupancy: e.target.value,
                          }))
                        }
                      />
                    </Field>
                            ...
                            <div className="flex-1 min-w-0">
                              <div className="relative group/desc">
                                <input
                                  ...
                                  onChange={(e) =>
                                    onUpdatePhotoDescription(i, e.target.value)
                                  }
                                />
                                <svg
                                  className="absolute right-2 top-1/2 -translate-y-1/2 w-3 h-3 text-muted-foreground/40 group-focus-within/desc:text-green-500 transition-colors pointer-events-none"
                                  viewBox="0 0 24 24"
                                  fill="none"
                                  stroke="currentColor"
                                  strokeWidth="2"
